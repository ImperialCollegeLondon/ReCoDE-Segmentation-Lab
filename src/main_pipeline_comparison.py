...
image3d = create_two_spheres_example(centre1=(6,6,6),radius1=2,centre2=(2,2,2),radius2=1)
# Two overlapping seperated spheres
image3d = create_two_spheres_example(centre1=(6,4,5),radius1=2,centre2=(4,2,2),radius2=2)

# Print a statement showing the crop
print(
    f"3D image size {np.shape(image3d)}"
)
...
print(f'Computation time Chamfer Distance: {np.round(time_chamfer,2)} seconds,'
...
print(f'Nr. of ocal minima: {np.shape(np.argwhere(local_minima))[0]}'
